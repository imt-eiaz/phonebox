      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
            Over 30,000 gadget repair since year of 2013
          </p>
        ...
        <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                If your device breaks, don't panic. We offer a huge range of
          ...
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Our trained technicians will repair your mobile phone or tablet
                device quickly & efficiently, while you waiting in most repairs.
              </p>
              <a className="mt-3 text-green-500 inline-flex items-center">
                Learn More
                <svg
          ...
          <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
            ...
            <div className="flex-grow">
              ...
              <p className="leading-relaxed text-base">
                Get discount prices on all repairs. We offer free screen
                protector in major repairs
              </p>
              <a className="mt-3 text-green-500 inline-flex items-center">
                Learn More
                <svg
